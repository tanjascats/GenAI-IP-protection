...
Adversarial perturbations &
  ...
  \begin{tabular}[c]{@{}l@{}}adversarial noise~\cite{zhao_unlearnable_2023}, style cloak / cloaking~\cite{shan_glaze_2023}, \\ poisoning~\cite{liu_toward_2023}, adversarial watermark(-ing)~\cite{zhang_editguard_2023}, \\ watermark(-ing)\cite{ye_duaw_2023}, immunisation~\cite{salman_raising_2023}\end{tabular} \\ \hline
Concept removal &
